...
class YOLODetector:
    def __init__(self,
        ...
        # 4´©ÅÔâú RTMPose (Absolute Best for this project)
        try:
    ...
    def detect(self, frame):
        ...
        # 1´©ÅÔâú HUMAN DETECTION (GPU FORCED)
        ...
        if human_results.boxes:
            for box in human_results.boxes:
                ...
                # 2´©ÅÔâú POSE ESTIMATION (RTMPose Primary, YOLO Fallback)
                if self.rtm_pose:
                ...
                # 3´©ÅÔâú FACE DETECTION (GPU FORCED)
